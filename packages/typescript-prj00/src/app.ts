...
class ProjectList {
  ...
  constructor(private type: "active" | "finished") {
    ...
    this.element = inportedNode.firstElementChild as HTMLElement;
...
const prjectListActive = new ProjectList("active");
const prjectListFinished = new ProjectList("finished");
